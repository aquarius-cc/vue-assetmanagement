...
import type { DamagedAsset, DamagedAssetCreateForm, DamagedAssetUpdateForm } from '@/utils/DamagedAsset'
 ...
 * 待报废资产 Store
 */
export const useDamagedAssetStore = createEntityStore<DamagedAsset, PaginationQuery>('damagedAsset', {
  idKey: 'damaged_asset',
  ...
  api: {
    ...
    update: (data) => damagedAssetAPI.updateDamagedAsset(data.damaged_asset!, data as DamagedAssetUpdateForm),
