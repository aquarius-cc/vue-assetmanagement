...
import type { FoundAssetExtended, FoundAssetCreateForm, FoundAssetUpdateForm } from '@/utils/FoundAsset'
import { ElMessage } from 'element-plus'
import type { PaginationQuery } from '@/stores/createEntityStore'

export const useFoundAssetStore = createEntityStore<FoundAssetExtended, PaginationQuery>('foundAsset', {
  idKey: 'recordcode',
