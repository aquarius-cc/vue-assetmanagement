...
import type { RecycleAssetExtended, RecycleAssetCreateForm, RecycleAssetUpdateForm } from '@/utils/RecycleAsset'
 ...
 * 回收资产 Store
 */
export const useRecycleAssetStore = createEntityStore<RecycleAssetExtended, PaginationQuery>('recycleAsset', {
