...
import type { RepairAssetExtended, RepairAssetCreateForm, RepairAssetUpdateForm } from '@/utils/RepairAsset'
 ...
 * 维修资产 Store
 */
export const useRepairAssetStore = createEntityStore<RepairAssetExtended, PaginationQuery>('repairAsset', {
  idKey: 'recordcode',
