...
describe('brokenAssetAPI', () => {
  ...
  it('updateBrokenAsset calls PUT /assets/broken-assets/{code}/', async () => {
    ...
    expect(mockRequest.put).toHaveBeenCalledWith('/assets/broken-assets/BA001/', {
      recordcode: 'BA001',
      description: 'Updated',
    })
  })
  ...
  it('updateBrokenAsset throws when recordcode is missing', () => {
    expect(() => brokenAssetAPI.updateBrokenAsset({ id: undefined } as never)).toThrow(
  ...
  it('batchDeleteBrokenAssets calls POST /assets/broken-assets/batch-delete/', async () => {
    ...
    expect(mockRequest.post).toHaveBeenCalledWith('/assets/broken-assets/batch-delete/', {
      ids: ['BA001', 'BA002'],
    })
  })
  ...
  it('batchCreateBrokenAssets calls POST /assets/broken-assets/batch-create/', async () => {
    ...
    expect(mockRequest.post).toHaveBeenCalledWith('/assets/broken-assets/batch-create/', {
