...
describe('repairAssetAPI', () => {
  ...
  it('getRepairAssetByCode calls GET /assets/repair-assets/{code}/', async () => {
    ...
    expect(mockRequest.get).toHaveBeenCalledWith('/assets/repair-assets/RP001/', undefined, true, 300000)
  })
  ...
  it('updateRepairAsset calls PUT /assets/repair-assets/{code}/', async () => {
    ...
    expect(mockRequest.put).toHaveBeenCalledWith('/assets/repair-assets/RP001/', { recordcode: 'RP001', description: 'Updated' })
  })

  it('updateRepairAsset throws when recordcode is missing', () => {
    expect(() => repairAssetAPI.updateRepairAsset({ id: undefined } as never)).toThrow('recordcode is required')
  })
  ...
  it('batchDeleteRepairAssets calls POST /assets/repair-assets/batch-delete/', async () => {
    ...
    expect(mockRequest.post).toHaveBeenCalledWith('/assets/repair-assets/batch-delete/', { ids: ['RP001', 'RP002'] })
  })
  ...
  it('batchCreateRepairAssets calls POST /assets/repair-assets/batch-create/', async () => {
    ...
    expect(mockRequest.post).toHaveBeenCalledWith('/assets/repair-assets/batch-create/', { items: [{ asset_code: 'A001' }] })
  })
  ...
  it('repairAsset calls POST /assets/assets/{code}/repair/', async () => {
    ...
    expect(mockRequest.post).toHaveBeenCalledWith('/assets/assets/A001/repair/', { asset_code: 'A001' })
  })
  ...
  it('repairDone calls POST /assets/assets/{code}/repair-done/', async () => {
    ...
    expect(mockRequest.post).toHaveBeenCalledWith('/assets/assets/A001/repair-done/', { description: 'Fixed' })
  })
  ...
  it('repairFailed calls POST /assets/assets/{code}/repair-failed/', async () => {
    ...
    expect(mockRequest.post).toHaveBeenCalledWith('/assets/assets/A001/repair-failed/', { description: 'Unfixable' })
  })
})
