...
describe('departmentAPI', () => {
  ...
  it('getDepartment calls GET /users/departments/{code}/', async () => {
    ...
    expect(mockRequest.get).toHaveBeenCalledWith('/users/departments/DEP001/', undefined, true, 300000)
  })
  ...
  it('createDepartment calls POST /users/departments/', async () => {
    ...
    expect(mockRequest.post).toHaveBeenCalledWith('/users/departments/', { department_name: 'New Dept' })
  })
  ...
  it('updateDepartment calls PUT /users/departments/{code}/', async () => {
    ...
    expect(mockRequest.put).toHaveBeenCalledWith('/users/departments/DEP001/', { department_code: 'DEP001', department_name: 'Updated' })
  })

  it('updateDepartment throws when department_code is missing', () => {
    expect(() => departmentAPI.updateDepartment({ department_name: 'Test' })).toThrow('department_code is required')
  })
  ...
  it('batchDeleteDepartments calls POST /users/departments/batch-delete/', async () => {
    ...
    expect(mockRequest.post).toHaveBeenCalledWith('/users/departments/batch-delete/', { ids: ['DEP001', 'DEP002'] })
  })
  ...
  it('batchCreateDepartments calls POST /users/departments/batch-create/', async () => {
    ...
    expect(mockRequest.post).toHaveBeenCalledWith('/users/departments/batch-create/', { items: [{ department_name: 'X' }] })
  })
  ...
  it('moveDepartment calls PUT /users/departments/{code}/move/', async () => {
    ...
    expect(mockRequest.put).toHaveBeenCalledWith('/users/departments/DEP001/move/', { parent_department_code: 'DEP002' })
  })
  ...
  it('sortDepartments calls PUT /users/departments/sort/', async () => {
    ...
    expect(mockRequest.put).toHaveBeenCalledWith('/users/departments/sort/', { items: [{ department_code: 'DEP001', sort_order: 1 }] })
  })

  it('getParentDepartment calls GET /users/departments/{code}/parent/', async () => {
    await departmentAPI.getParentDepartment('DEP001')
    expect(mockRequest.get).toHaveBeenCalledWith('/users/departments/DEP001/parent/', undefined, true, 300000)
  })
})
