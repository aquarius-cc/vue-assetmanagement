...
describe('userAPI', () => {
  ...
  it('updateUser calls PUT /users/employees/{code}/', async () => {
    ...
    expect(mockRequest.put).toHaveBeenCalledWith('/users/employees/E001/', {
  ...
  it('updateUser throws when employee_jobcode is missing', () => {
    expect(() => userAPI.updateUser({ employee_name: 'Test' })).toThrow(
      'employee_jobcode is required',
    )
  })
  ...
  it('batchDeleteUsers calls POST /users/employees/batch-delete/', async () => {
    ...
    expect(mockRequest.post).toHaveBeenCalledWith('/users/employees/batch-delete/', {
      ids: ['E001', 'E002'],
    })
  })
  ...
  it('batchUpdateSort calls PUT /users/employees/sort/', async () => {
    ...
    expect(mockRequest.put).toHaveBeenCalledWith('/users/employees/sort/', {
      items: [{ employee_jobcode: 'E001', sort_order: 1 }],
    })
  })
  ...
  it('getEmployeeDepartment calls GET /users/employees/{code}/department/', async () => {
    ...
    expect(mockRequest.get).toHaveBeenCalledWith(
      '/users/employees/E001/department/',
      undefined,
      true,
      300000,
    )
