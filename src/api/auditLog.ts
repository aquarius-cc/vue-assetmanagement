...
export const auditLogAPI = {
  ...
  getAuditLogDetail: (pk: number | string): Promise<AuditLog> => {
    return unwrapResponse(request.get<AuditLog>(
      `/audit-logs/${pk}/`,
      undefined,
      true,
      300000,
   ...
   */
  getAuditLogsByApp: (appLabel: string, params?: AuditLogQueryParams): Promise<AuditLogListResponse> => {
    return unwrapResponse(request.get<AuditLogListResponse>(`/audit-logs/by-app/${appLabel}/`, params))
  },
   ...
   */
  getAuditLogsByOperator: (jobcode: string, params?: AuditLogQueryParams): Promise<AuditLogListResponse> => {
    return unwrapResponse(request.get<AuditLogListResponse>(`/audit-logs/by-operator/${jobcode}/`, params))
  },
}
